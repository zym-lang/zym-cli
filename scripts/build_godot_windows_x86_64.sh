#!/usr/bin/env bash
# Build Godot as a static library for windows_x86_64.
#
# Produces:
#   <repo>/godot/bin/libgodot.linuxbsd.template_release.x86_64.a
#
# Usage:
#   scripts/build_godot_windows_x86_64.sh [extra scons args...]
#
# This script is invoked by the top-level CMakeLists.txt when
# ZYM_PRECOMPILE_GODOT=ON and ZYM_GODOT_PLATFORM=windows_x86_64.
